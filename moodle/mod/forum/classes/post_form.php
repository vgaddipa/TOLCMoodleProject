...
class mod_forum_post_form extends moodleform {
    ...
    function definition() {
        ...
        /* Author: Sumanth Kulkarni
         * Course: Technologies for Online Learning Communities
         * ASU ID: 1206213511
         */
        
        // Adding a checkbox for posting replies anonymously
        $mform->addElement('checkbox', 'anonreplies', 'Post as anonymous');
